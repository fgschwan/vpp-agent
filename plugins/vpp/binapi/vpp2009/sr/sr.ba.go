...
// Srv6SidListWithSlIndex represents VPP binary API type 'srv6_sid_list_with_sl_index'.
...
func (*Srv6SidListWithSlIndex) GetTypeName() string { return "srv6_sid_list_with_sl_index" }
...
// SrPoliciesWithSlIndexDetails represents VPP binary API message 'sr_policies_with_sl_index_details'.
type SrPoliciesWithSlIndexDetails struct {
	...
	FibTable    uint32
	NumSidLists uint8 `struc:"sizeof=SidLists"`
	SidLists    []Srv6SidListWithSlIndex
}
...
func (*SrPoliciesWithSlIndexDetails) GetMessageType() api.MessageType { return api.ReplyMessage }

// SrPoliciesWithSlIndexDump represents VPP binary API message 'sr_policies_with_sl_index_dump'.
...
func (*SrPoliciesWithSlIndexDump) GetMessageType() api.MessageType { return api.RequestMessage }
...
func init() {
	...
	api.RegisterMessage((*SrPoliciesWithSlIndexDetails)(nil), "sr.SrPoliciesWithSlIndexDetails")
	api.RegisterMessage((*SrPoliciesWithSlIndexDump)(nil), "sr.SrPoliciesWithSlIndexDump")
...
type RPCService interface {
	...
	DumpSrPoliciesWithSlIndex(ctx context.Context, in *SrPoliciesWithSlIndexDump) (RPCService_DumpSrPoliciesWithSlIndexClient, error)
...
func (c *serviceClient) DumpSrPoliciesWithSlIndex(ctx context.Context, in *SrPoliciesWithSlIndexDump) (RPCService_DumpSrPoliciesWithSlIndexClient, error) {
	stream := c.ch.SendMultiRequest(in)
	x := &serviceClient_DumpSrPoliciesWithSlIndexClient{stream}
	return x, nil
}

type RPCService_DumpSrPoliciesWithSlIndexClient interface {
	Recv() (*SrPoliciesWithSlIndexDetails, error)
}

type serviceClient_DumpSrPoliciesWithSlIndexClient struct {
	api.MultiRequestCtx
}

func (c *serviceClient_DumpSrPoliciesWithSlIndexClient) Recv() (*SrPoliciesWithSlIndexDetails, error) {
	m := new(SrPoliciesWithSlIndexDetails)
	stop, err := c.MultiRequestCtx.ReceiveReply(m)
	if err != nil {
		return nil, err
	}
