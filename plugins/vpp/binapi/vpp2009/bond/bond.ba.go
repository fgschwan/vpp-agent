...
// BondAddMember represents VPP binary API message 'bond_add_member'.
...
func (*BondAddMember) GetMessageType() api.MessageType { return api.RequestMessage }

// BondAddMemberReply represents VPP binary API message 'bond_add_member_reply'.
...
func (*BondAddMemberReply) GetMessageType() api.MessageType { return api.ReplyMessage }
...
// BondDetachMember represents VPP binary API message 'bond_detach_member'.
...
func (*BondDetachMember) GetMessageType() api.MessageType { return api.RequestMessage }

// BondDetachMemberReply represents VPP binary API message 'bond_detach_member_reply'.
...
func (*BondDetachMemberReply) GetMessageType() api.MessageType { return api.ReplyMessage }
...
// SwBondInterfaceDetails represents VPP binary API message 'sw_bond_interface_details'.
...
func (*SwBondInterfaceDetails) GetMessageType() api.MessageType { return api.ReplyMessage }

// SwBondInterfaceDump represents VPP binary API message 'sw_bond_interface_dump'.
...
func (*SwBondInterfaceDump) GetMessageType() api.MessageType { return api.RequestMessage }
...
// SwMemberInterfaceDetails represents VPP binary API message 'sw_member_interface_details'.
...
func (*SwMemberInterfaceDetails) GetMessageType() api.MessageType { return api.ReplyMessage }

// SwMemberInterfaceDump represents VPP binary API message 'sw_member_interface_dump'.
...
func (*SwMemberInterfaceDump) GetMessageType() api.MessageType { return api.RequestMessage }
...
func init() {
	...
	api.RegisterMessage((*BondDetachMember)(nil), "bond.BondDetachMember")
	api.RegisterMessage((*BondDetachMemberReply)(nil), "bond.BondDetachMemberReply")
	...
	api.RegisterMessage((*SwBondInterfaceDetails)(nil), "bond.SwBondInterfaceDetails")
	api.RegisterMessage((*SwBondInterfaceDump)(nil), "bond.SwBondInterfaceDump")
	...
	api.RegisterMessage((*SwMemberInterfaceDetails)(nil), "bond.SwMemberInterfaceDetails")
	api.RegisterMessage((*SwMemberInterfaceDump)(nil), "bond.SwMemberInterfaceDump")
}
...
type RPCService interface {
	DumpSwBondInterface(ctx context.Context, in *SwBondInterfaceDump) (RPCService_DumpSwBondInterfaceClient, error)
...
func (c *serviceClient) DumpSwBondInterface(ctx context.Context, in *SwBondInterfaceDump) (RPCService_DumpSwBondInterfaceClient, error) {
	stream := c.ch.SendMultiRequest(in)
	x := &serviceClient_DumpSwBondInterfaceClient{stream}
	return x, nil
}

type RPCService_DumpSwBondInterfaceClient interface {
	Recv() (*SwBondInterfaceDetails, error)
}

type serviceClient_DumpSwBondInterfaceClient struct {
	api.MultiRequestCtx
}

func (c *serviceClient_DumpSwBondInterfaceClient) Recv() (*SwBondInterfaceDetails, error) {
	m := new(SwBondInterfaceDetails)
...
func (c *serviceClient) DumpSwMemberInterface(ctx context.Context, in *SwMemberInterfaceDump) (RPCService_DumpSwMemberInterfaceClient, error) {
	stream := c.ch.SendMultiRequest(in)
	x := &serviceClient_DumpSwMemberInterfaceClient{stream}
	return x, nil
}

type RPCService_DumpSwMemberInterfaceClient interface {
	Recv() (*SwMemberInterfaceDetails, error)
}

type serviceClient_DumpSwMemberInterfaceClient struct {
	api.MultiRequestCtx
}

func (c *serviceClient_DumpSwMemberInterfaceClient) Recv() (*SwMemberInterfaceDetails, error) {
	m := new(SwMemberInterfaceDetails)
	stop, err := c.MultiRequestCtx.ReceiveReply(m)
	if err != nil {
		return nil, err
	}
