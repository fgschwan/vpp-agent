...
// GtpuTunnelUpdateTteid represents VPP binary API message 'gtpu_tunnel_update_tteid'.
...
func (*GtpuTunnelUpdateTteid) GetMessageType() api.MessageType { return api.RequestMessage }

// GtpuTunnelUpdateTteidReply represents VPP binary API message 'gtpu_tunnel_update_tteid_reply'.
...
func (*GtpuTunnelUpdateTteidReply) GetMessageType() api.MessageType { return api.ReplyMessage }
...
func init() {
	...
	api.RegisterMessage((*GtpuTunnelUpdateTteid)(nil), "gtpu.GtpuTunnelUpdateTteid")
	api.RegisterMessage((*GtpuTunnelUpdateTteidReply)(nil), "gtpu.GtpuTunnelUpdateTteidReply")
